...
class Medico
{
	...
	{	
		$this->Conexion=Conectarse();
		$sql="update medicos set medIdentificacion='$this->identificacion',medNombres='$this->nombres',medApellidos='$this->apellidos',medEspecialidad='$this->especialidad',medTelefono='$this->telefono',medCorreo='$this->correo' where idMedico = '$_POST[idMedico]'";
		$resultado=$this->Conexion->query($sql);
		$this->Conexion->close();
		return $resultado;	
	}
